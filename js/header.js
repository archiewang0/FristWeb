...
const h3 = document.querySelector('section.product > div.right > div.right-inner > h3')
...
cartBdoy.addEventListener('click', (e) => {
    if (cartForm.offsetLeft > e.pageX) {
        cartBdoy.classList.remove('cart_show')
    }
})
...
const memberForm = document.querySelector('div.memberForm')
...
memberBody.addEventListener('click',(e)=>{
  if (memberForm.offsetLeft > e.pageX) {
    memberBody.classList.remove('member_show')
  }
})
